...
import { Megaphone, BadgeAlert } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Admin-visible employees in the database
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Live rows for today</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            {announcements.length === 0 ? (
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {announcements.slice(0, 6).map(ann => (
                  <div key={ann.id} className="border rounded-lg p-4 bg-muted/10">
